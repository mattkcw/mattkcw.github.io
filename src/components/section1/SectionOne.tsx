    ...
    <section id="Products" className="pt-10 pb-24">
          ...
          {isAboveMediumScreen ? (
            ...
            >
              <img
                alt="skills"
                className="z-10"
                src="src/assets/images/windows.png"
              />
            </div>
          ) : (
            <img alt="skills" className="z-10" src="src/assets/images/windows.png" />
          )}
        </div>
      </div>
      ...
      <div className="md:flex md:justify-between mt-16 gap-32">
        ...
        >
          ...
          <img src="src/assets/images/construction.png" alt="new construction windows" />
        </motion.div>
        ...
        >
          ...
          <img src="src/assets/images/replacement.png" alt="replacement windows" />
        </motion.div>
        {/* IMAGINATIVE */}
        <motion.div
          className="md:w-1/3 mt-10"
        ...
        >
          ...
          <img src="src/assets/images/sliding.png" alt="sliding glass doors" />
        </motion.div>
      </div>
    </section>
  )
